...
var Key = (function (superclass) {
  ...
  if ( superclass ) Key.__proto__ = superclass;
  Key.prototype = Object.create( superclass && superclass.prototype );
  Key.prototype.constructor = Key;

  Key.prototype.onClick = function onClick () {
  ...
  Key.prototype.render = function render () {
    return (
      react.createElement( 'span', { style: {color: colours$1[this.state.keyIndex]}, onClick: this.onClick },
...
var jsonDisplay = (react.createElement( 'pre', { id: 'code' }, JSON.stringify(example, null, 2)));
