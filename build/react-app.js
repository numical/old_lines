...
function P(a,b,e){var d=a.result,c=a.keyPrefix;a=a.func.call(a.context,b,a.count++);Array.isArray(a)?Q(a,d,e,emptyFunction_1.thatReturnsArgument):null!=a&&(E(a)&&(b=c+(!a.key||b&&b.key===a.key?"":(""+a.key).replace(I,"$\x26/")+"/")+e,a={$$typeof:B,type:a.type,key:b,ref:a.ref,props:a.props,_owner:a._owner}),d.push(a));}function Q(a,b,e,d,c){var h="";null!=e&&(h=(""+e).replace(I,"$\x26/")+"/");b=K(b,h,d,c);null==a||M(a,"",P,b);L(b);}"function"===typeof Symbol&&Symbol["for"]&&Symbol["for"]("react.fragment");
var R={Children:{map:function(a,b,e){if(null==a){ return a; }var d=[];Q(a,d,null,b,e);return d},forEach:function(a,b,e){if(null==a){ return a; }b=K(null,null,b,e);null==a||M(a,"",O,b);L(b);},count:function(a){return null==a?0:M(a,"",emptyFunction_1.thatReturnsNull,null)},toArray:function(a){var b=[];Q(a,b,null,emptyFunction_1.thatReturnsArgument);return b},only:function(a){E(a)?void 0:q("143");return a}},Component:t,PureComponent:u,unstable_AsyncComponent:x,createElement:D,cloneElement:function(a,b,e){
var arguments$1 = arguments;
...
var Graph = function () { return (react.createElement( 'div', null, "The Graph" )); };

var Finances = function () { return (react.createElement( 'div', null, "Finances - accouns, savings, pension etc." )); };

var Events = function () { return (react.createElement( 'div', null, "Life Events - new job, buy house, maternity, retirement etc." )); };

var Targets = function () { return (react.createElement( 'div', null, "Targets - sufficient house deposit, minimum pension level etc. " )); };

var getContainer = function () { return (
  react.createElement( 'div', null,
    react.createElement( Graph, null ),
    react.createElement( Finances, null ),
